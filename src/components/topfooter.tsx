export const TopFooter = () => {
  return (
    <div className="container flex flex-col justify-center items-center py-8 px-5 mx-auto text-gray-600">
      <div className="flex flex-col items-center mb-4 w-full text-center md:w-2/3">
